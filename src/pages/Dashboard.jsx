...
const Dashboard = () => {
  ...
  return (
    <div className="flex gap-10 relative">
      ...
      {update && (
        <div className="absolute bg-black/70 top-0 right-0 left-0 bottom-0 z-50">
          <div className="flex justify-center items-center h-screen ">
            <div className="bg-white py-8 px-4 flex flex-col gap-6">
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    id="image"
                    ref={imgRef}
                    className="border-2 border-black px-1 py-2 ml-2"
              ...
              <div className="flex gap-4 justify-center items-center">
                <button
                  className="py-2 px-5 font-medium bg-red-600 text-white rounded-md"
                  onClick={() => setUpdate(false)}>
                  Cancel
                </button>
                <button
                  className="py-2 px-5 bg-dGreen text-white rounded-md font-medium"
      ...
      {confirmDeactivate && (
        <div className="absolute bg-black/70 px-2 top-0 right-0 left-0 bottom-0 z-50">
          <div className="flex justify-center items-center h-screen ">
            <div className="bg-white py-8 px-4 flex flex-col gap-6">
              <p className="text-black text-center bg-white text-lg">
                Are you sure you want to <b>PERMANENTLY deactivate</b> your
                account?
              </p>
              <div className="flex gap-6 justify-center items-center">
                <button
                  className="py-2 px-5 font-medium bg-dGreen text-white rounded-md"
                  onClick={() => setConfirmDeactivate(false)}>
                  Cancel
                </button>
                <button
                  className="p-2 bg-red-600 text-white rounded-md font-medium"
                  onClick={() => {
      ...
      <div className="flex flex-col gap-5 py-12">
        {user.photoURL ? (
          <img
            src={user.photoURL}
            alt="user dp"
            className="w-56 h-56 cursor-pointer rounded-full object-cover"
          />
        ) : (
          <CgProfile className="w-56 h-56 relative cursor-pointer text-gray-700"></CgProfile>
        )}
        <div className="md:w-[30vw] flex flex-col gap-3">
          ...
          <div className="shadow-md py-3 px-4 text-dBlue flex justify-between">
            ...
            {!user.emailVerified && (
              <button
                className="rounded-md text-dGreen font-semibold hover:text-dGreen/80"
        ...
        <div className="flex gap-6 w-full mt-5">
          <button
            className=" p-2 bg-dGreen text-white rounded-md"

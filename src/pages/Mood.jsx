    ...
    <>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center mt-10 md:items-start md:mt-28 h-screen  px-10 md:justify-between md:gap-20">
        <div className="flex flex-col justify-center items-center  md:w-[50vw]">
          <img
            src="undraw-smiley-face.svg"
            alt=""
            className="shrink-0 w-[80%] sm:w-[60%] md:w-[100%] lg:w-[80%]"
          />
          <img
            src="blob-egg.svg"
            alt=""
            className="absolute -z-10 top-44 ml-10 md:w-[700px] md:top-36 lg:top-32"
          />
          <p className=" md:hidden text-xl text-center lg:text-center mt-2 font-semibold text-[#292b4c] lg:text-2xl">
            How are you feeling today, <br /> {user.displayName}?
          </p>
        </div>

        <div>
          <div className="md:w-[40vw] lg:w-[50vw] md:flex md:flex-col md:justify-center md:items-center md:gap-10">
            <p className="hidden md:block text-xl text-center lg:text-center mt-2 font-semibold text-[#292b4c] lg:text-2xl">
              How are you feeling today, <br /> {user.displayName}?
            </p>
          ...
          <div className="flex justify-center">
            <button
              className=" pr-4 py-2 w-[75%] md:w-[85%] lg:w-[55%] text-white font-bold text-lg bg-[#89c6a9] mt-4 md:m-12 rounded-xl"
              id="saveMoodBtn">
              <Link
                to="/dairy"
                className="flex text-center items-center justify-end gap-16 md:gap-28">

  ...
  return (
    <>
      <div className="p-5 w-auto flex flex-col gap-3">
        {showEmoji && (
          <div className="text-sm text-dGreen absolute bg-white bottom-0 right-0 z-20">
            <Picker
        ...
        {postsData
          ...
          .map((post, index) => (
            <div
              className="bg-white p-4 text-gray-500 text-sm rounded-xl"
              key={post.time}>
              <div className="flex gap-2 relative">
                ...
                <div className="mt-1 w-full">
                  <div className=" flex justify-between">
                    <div className="flex gap-2 mb-2 items-center">
                      ...
                      <span className="text-[13px]">
                        <Timeago
                          date={new Date(post.time?.toDate()).toLocaleString()}
                          formatter={formatter}
                        />
                      </span>
                    </div>
                  ...
                  {postOptions === index && (
                    <div className="absolute top-5 right-0 bg-white shadow-md p-4 flex flex-col gap-3 rounded-xl z-20 ">
                      <div
                  ...
                  <div className="leading-7 md:max-w-[500px]">
                    {post.postText}
                  </div>
              ...
              <div className="px-10">
                <div className="pt-6 text-xl flex cursor-pointer gap-3">
                  ...
                  <p
                    className="text-sm font-semibold text-dBlue"
